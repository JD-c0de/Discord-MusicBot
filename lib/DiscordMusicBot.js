...
class DiscordMusicBot extends Client {
  ...
  LoadCommands() {
    //Music commands
    let SlashCommandsDirectoryMusic = path.join(
      __dirname,
      "..",
      "commands",
      "slash",
    ...
    fs.readdir(SlashCommandsDirectoryMusic, (err, files) => {
      if (err) throw err;
      else
        files.forEach((file) => {
          let cmd = require(SlashCommandsDirectoryMusic + "/" + file);
          if (!cmd || !cmd.run)
            return this.warn(
    ...
    //Games commands
    let SlashCommandsDirectoryGames = path.join(
      __dirname,
      "..",
      "commands",
      "slash",
    ...
    fs.readdir(SlashCommandsDirectoryGames, (err, files) => {
      if (err) throw err;
      else
        files.forEach((file) => {
          let cmd = require(SlashCommandsDirectoryGames + "/" + file);
          if (!cmd || !cmd.run)
            return this.warn(
              "Unable to load Command: " +
                file.split(".")[0] +
    ...
    //Birthday commands
    let SlashCommandsDirectoryBirthday = path.join(
      __dirname,
      "..",
      "commands",
      "slash",
    ...
    fs.readdir(SlashCommandsDirectoryBirthday, (err, files) => {
      if (err) throw err;
      else
        files.forEach((file) => {
          let cmd = require(SlashCommandsDirectoryBirthday + "/" + file);
          if (!cmd || !cmd.run)
            return this.warn(
              "Unable to load Command: " +
                file.split(".")[0] +
    ...
    //Settings commands
    let SlashCommandsDirectorySettings = path.join(
      __dirname,
      "..",
      "commands",
      "slash",
    ...
    fs.readdir(SlashCommandsDirectorySettings, (err, files) => {
      if (err) throw err;
      else
        files.forEach((file) => {
          let cmd = require(SlashCommandsDirectorySettings + "/" + file);
          if (!cmd || !cmd.run)
            return this.warn(
              "Unable to load Command: " +
                file.split(".")[0] +
    ...
    //Other commands
    let SlashCommandsDirectoryOther = path.join(
      __dirname,
      "..",
      "commands",
      "slash",
    ...
    fs.readdir(SlashCommandsDirectoryOther, (err, files) => {
      if (err) throw err;
      else
        files.forEach((file) => {
          let cmd = require(SlashCommandsDirectoryOther + "/" + file);
          if (!cmd || !cmd.run)
            return this.warn(
              "Unable to load Command: " +
                file.split(".")[0] +
