...
class DiscordMusicBot extends Client {
  constructor(props) {
    ...
    this.gamesCommands = new Collection();
    this.birthdayCommands = new Collection();
    this.settingsCommands = new Collection();
    this.otherCommands = new Collection();
...
LoadCommands() {
    ...
    fs.readdir(MusicCommandsDir, (err, files) => {
      ...
      files.forEach((file) => {
        ...
        this.musicCommands.set(file.split(".")[0].toLowerCase(), cmd);
        this.log("Command Loaded: " + file.split(".")[0]);
      });
    });
    ...
    fs.readdir(GamesCommandsDir, (err, files) => {
      ...
      files.forEach((file) => {
        ...
        this.gamesCommands.set(file.split(".")[0].toLowerCase(), cmd);
        this.log("Command Loaded: " + file.split(".")[0]);
      });
    });
    ...
    fs.readdir(BirthdayCommandsDir, (err, files) => {
      ...
      files.forEach((file) => {
        ...
        this.birthdayCommands.set(file.split(".")[0].toLowerCase(), cmd);
        this.log("Command Loaded: " + file.split(".")[0]);
      });
    });
    ...
    fs.readdir(SettingsCommandsDir, (err, files) => {
      ...
      files.forEach((file) => {
        ...
        this.settingsCommands.set(file.split(".")[0].toLowerCase(), cmd);
        this.log("Command Loaded: " + file.split(".")[0]);
      });
    });
    ...
    fs.readdir(OtherCommandsDir, (err, files) => {
      ...
      files.forEach((file) => {
        ...
        this.otherCommands.set(file.split(".")[0].toLowerCase(), cmd);
        this.log("Command Loaded: " + file.split(".")[0]);
      });
    });
  }
