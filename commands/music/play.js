...
module.exports = {
  name: "play",
  description: "Play your favorite songs (including youtube and spotify links!)",
  usage: "[song]",
  permissions: {
  ...
  run: async (client, message, args, { GuildDB }) => {
    ...
    if (!CheckNode || !CheckNode.connected) {
      return client.sendTime(
        message.channel,
        "❌ | **Sadly, the server is temporarily down, but all non-music related commands still work!** | **(Lavalink node / server not connected)**"
      );
    }
