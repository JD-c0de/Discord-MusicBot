...
module.exports = {
  ...
  usage: "<none|low|medium|high|earrape>",
  permissions: {
  ...
  run: async (client, message, args, { GuildDB }) => {
    ...
    if (!args[0])
      return client.sendTime(
        message.channel,
        "**Please provide a bassboost level. \nAvailable Levels:** `none`, `low`, `medium`, `high`, `earrape`"
  ...
  SlashCommand: {
    options: [
      {
        name: "level",
        description: `Please provide a bassboost level. Available Levels: low, medium, high, earrape or none`,
        value: "[level]",
        type: 3,
        required: true,
      },
