...
const command = new SlashCommand()
  .setName("sketchyartist")
  .setDescription("Which artist is sketchy and draws the wrong drawing?")
  .setRun(async (client, interaction, options) => {
    ...
    fetch(`https://discord.com/api/v9/channels/${channel.id}/invites`, {
      ...
      const Embed = new MessageEmbed()
        ...
        .setColor(client.config.embedColor)
        .setDescription(`Using **Sketchy Artist** you can play a Sketchy Artist game with your friends in a Voice Channel. Click *Join Sketchy Artist* to join in!
