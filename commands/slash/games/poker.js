...
const command = new SlashCommand()
  .setName("poker")
  .setDescription("Starts a Poker session (18+) **(NOTE: <a:animatedboost:947794922185064478> lvl 1 required)**")
  .setRun(async (client, interaction, options) => {
    ...
    fetch(`https://discord.com/api/v9/channels/${channel.id}/invites`, {
      ...
      const Embed = new MessageEmbed()
        ...
        .setColor(client.config.embedColor)
        .setDescription(`Using **Poker Night** you can play Poker with your friends in a Voice Channel. Click *Join Poker Night* to join in! **(NOTE: <a:animatedboost:947794922185064478> lvl 1 required)**
