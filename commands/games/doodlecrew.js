...
module.exports = {
    name: "doodlecrew",
    description: "Doodle Crew is a drawing and guessing game",
    usage: "",
    permissions: {
    ...
    run: async (client, message, args, { GuildDB }) => {
        ...
        .setAuthor("Doodle crew", "https://cdn.discordapp.com/app-assets/878067389634314250/916017918502920263.png")
        .setColor("#83b9ff")
        .setDescription(`
Using **Doodle crew** you can play a Doodle crew game with your friends in a Voice Channel. Click *Join Doodle crew* to join in!
...
`)
     ...
     */
        run: async (client, interaction, args, { GuildDB }) => {
            ...
            let Invite = await member.voice.channel.activityInvite("878067389634314250")//Made using discordjs-activity package
            let embed = new MessageEmbed()
            .setAuthor("Doodle crew", "https://cdn.discordapp.com/app-assets/878067389634314250/916017918502920263.png")
            .setColor("#83b9ff")
            .setDescription(`
